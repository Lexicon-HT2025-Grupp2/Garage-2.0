...
namespace Garage_2._0.Controllers
{
    public class ParkingSpotsController : Controller
    {
        ...
        public ParkingSpotsController(Garage_2_0Context context)
        {
            _context = context;
        }
        ...
        {
            ViewData["ParentId"] = new SelectList(_context.ParkingSpots, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ParentId,Name")] ParkingSpot parkingSpot)
        {
            ...
            ViewData["ParentId"] = new SelectList(_context.ParkingSpots, "Id", "Id", parkingSpot.ParentId);
            return View(parkingSpot);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ParentId,Name")] ParkingSpot parkingSpot)
        {
